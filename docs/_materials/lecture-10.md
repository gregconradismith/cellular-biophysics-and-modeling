...
1.  <strong>The Morris-Lecar Model.</strong> Chapter 14 of <em>Cellular Biophysics and Modeling: A primer on the computational biology of excitable cells.</em>
...
3.  Begin reading Ermentrout & Terman 2010 (pp. 49-63, that is, Sections 3.1 to 3.4). This chapter of their monograph, <em>Mathematical Foundations of Neuroscience,</em> discusses excitability and oscillations exhibited by the Morris-Lecar model, as well as phase planes, linear stability analysis, and several bifurcations that occur in ODE models with two state variables (e.g., the Hopf bifurcation, saddle-node on a limit cycle bifurcation, and saddle homoclinic bifurcation).
